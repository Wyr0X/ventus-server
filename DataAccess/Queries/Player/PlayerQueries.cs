namespace VentusServer.DataAccess.Queries
{
    ...
    CREATE TABLE IF NOT EXISTS players (
        ...
        input_bindings JSONB DEFAULT '[]',
        hotbar JSONB DEFAULT '[]'
    );";
        ...
        public const string Insert = @"
            INSERT INTO players (account_id, name, gender, race, level, class, created_at, last_login, status, input_bindings, hotbar)
            VALUES (@AccountId, @Name, @Gender, @Race, @Level, @Class, @CreatedAt, @LastLogin, @Status, @InputBindings, @Hotbar)
            RETURNING id;";

        public const string Upsert = @"
            INSERT INTO players (id, account_id, name, gender, race, level, class, created_at, last_login, status, input_bindings, hotbar)
            VALUES (@Id, @AccountId, @Name, @Gender, @Race, @Level, @Class, @CreatedAt, @LastLogin, @Status, @InputBindings, @Hotbar)
        ...
        // Nuevas consultas para input handling (ya no son necesarias si se usan columnas JSONB)
    }
}
