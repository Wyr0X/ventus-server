...
public class SessionManager
{
    ...
    public SessionManager(GameEngine game,
    ...
    public async void HandlePlayerJoin(UserMessagePair messagePair)
    {
        ...
        ClientMessageGameSession sessionMessage = clientMessageGame
            .MessageSession;
        PlayerJoin playerJoinMessage = sessionMessage.PlayerJoin;

        PlayerLocation? playerLocation = await _playerLocationService.GetPlayerLocationAsync(playerJoinMessage.PlayerId);

        PlayerModel? playerModel = await _playerService.GetPlayerByIdAsync(playerJoinMessage.PlayerId);
